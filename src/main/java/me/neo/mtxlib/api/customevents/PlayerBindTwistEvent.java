...
/**
 * Fired immediately before a {@link Player} is bound to a {@link me.neo.mtxlib.api.twist.Twist}.
...
public class PlayerBindTwistEvent extends Event implements Cancellable {
    ...
    /**
     * Returns the {@link Player} being bound.
    ...
    /**
     * Returns the {@link me.neo.mtxlib.api.twist.Twist} the player is being bound to.
