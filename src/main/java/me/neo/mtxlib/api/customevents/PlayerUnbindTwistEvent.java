...
/**
 * Fired immediately before a {@link Player} is unbound from a {@link me.neo.mtxlib.api.twist.Twist}.
...
public class PlayerUnbindTwistEvent extends Event implements Cancellable {
    ...
    /**
     * Returns the {@link me.neo.mtxlib.api.twist.Twist} the player is being unbound from.
