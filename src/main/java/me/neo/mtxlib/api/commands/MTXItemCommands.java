...
public class MTXItemCommands {
    ...
    protected CommandAPICommand give() {
        return new CommandAPICommand("give")
                .withArguments(new PlayerArgument("player"), new GreedyStringArgument("item name").replaceSuggestions(ArgumentSuggestions.strings(MTXRegistries.itemNames)))
                ...
                .executesPlayer((sender, args) -> {
                    ...
                    MTXItem<?> item = (MTXItem<?>) MTXRegistries.get(itemName);
                    if (item == null) {
